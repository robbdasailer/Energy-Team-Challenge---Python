...
capex_PEM_electrolyer = 700 * 10 **6 # = 700 €/kW
...
opex_PEM_electrolyzer = 0.04 * capex_PEM_electrolyer
...
cash_outflow_FT_synthesis = opex_FT_synthesis * capacity_FT_synthesis
...
init_investment_expr =   (capex_photovoltaic * capacity_photovoltaic 
                    ...
                    + capex_PEM_electrolyer * capacity_PEM_electrolyzer
...
print("transported_jetfuel", transported_jetfuel)
